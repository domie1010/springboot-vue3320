...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateShenqinggenghuanyinxingka.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改申请更换银行卡<input type="hidden" name="id" value="${shenqinggenghuanyinxingka.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.shenqingren.value='${shenqinggenghuanyinxingka.shenqingren}';</script>	<script language="javascript">document.form1.xinyinxingka.value='${shenqinggenghuanyinxingka.xinyinxingka}';</script>	<script language="javascript">document.form1.shenqingshijian.value='${shenqinggenghuanyinxingka.shenqingshijian}';</script>	<script language="javascript">document.form1.shenqingyuanyin.value='${shenqinggenghuanyinxingka.shenqingyuanyin}';</script>	
					 </table>
			</form>
   </body>
</html>
