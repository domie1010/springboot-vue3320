					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						...
						<td style="padding-left:0px; padding-right:0px;"><table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#ebf0f7">
                          <tr>
                            <td align="center" bgcolor="#ebf0f7" width="30">序号</td>
                            <td width="105" align='center'>学号</td>
    <td width="93" align='center'>密码</td>
    <td width="120" align='center'>姓名</td>
    <td  width='60' align='center'>性别</td>
    <td width="111" align='center'>年龄</td>
    <td width="103" align='center'>院校</td>
    <td width="148" align='center'>联系方式</td>
    <td width="129" align='center'>银行卡</td>
    <td  width='91' align='center'>是否审核</td>
                            <td align="center" bgcolor="#ebf0f7" width="150"> 添加时间 </td>
                            <td align="center" bgcolor="#ebf0f7" width="150"> 操作 </td>
                          </tr>
                          <%
					int i=0;
				%>
