...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="shenqingzizhuList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.zizhupici}</td>    <td>${u.zizhujine}</td>    <td>${u.zhuangtai}</td>    <td>${u.shenqingren}</td>    <td>${u.shenqingriqi}</td>    <td width='90' align='center'><a href='${u.shenqingyangbiao}' target='_blank'><img src='${u.shenqingyangbiao}' width=88 height=99 border=0 /></a></td>    <td align='center'>${u.issh} </td>
                              ...
                              <td align="center"><a href="doUpdateShenqingzizhu.do?id=${u.id }">编辑</a>  <a href="deleteShenqingzizhu.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="shenqingzizhuDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="shenqingzizhuList2.do?page=1" >首页</a>
             <a href="shenqingzizhuList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shenqingzizhuList2.do?page=${page.page+1 }">下一页</a>
			<a href="shenqingzizhuList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
