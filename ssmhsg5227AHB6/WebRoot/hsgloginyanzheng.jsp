...
<html>
 ...
 String sql="";
 if(cx.equals("基金会")){sql="select * from allusers where username='"+uid+"' and pwd='"+pwd+"'";}

 if(cx.equals("学生")){sql="select * from xueshengxinxi where xuehao='"+uid+"' and mima='"+pwd+"'	and issh='是'";}

 if(cx.equals("教师")){sql="select * from jiaoshixinxi where yonghuming='"+uid+"' and mima='"+pwd+"'";}
 //quxanxiaxndexnglxu
