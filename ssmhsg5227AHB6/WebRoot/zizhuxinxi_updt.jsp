...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateZizhuxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改资助信息<input type="hidden" name="id" value="${zizhuxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.zizhupici.value='${zizhuxinxi.zizhupici}';</script>	<script language="javascript">document.form1.zizhujine.value='${zizhuxinxi.zizhujine}';</script>	<script language="javascript">document.form1.xiangxi.value='${zizhuxinxi.xiangxi}';</script>	<script language="javascript">document.form1.tupian.value='${zizhuxinxi.tupian}';</script>	
					 </table>
			</form>
   </body>
</html>
